...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-sxr+h*kov&aj5ifud7*bh_31bcxcl+@p47vfy&^%+swhtv*1s$')
...
# Используйте DATABASE_URL для production (например, PostgreSQL)
# Формат: postgresql://user:password@host:port/dbname
DATABASE_URL = os.environ.get('DATABASE_URL')

if DATABASE_URL:
    # Для PostgreSQL/MySQL через DATABASE_URL
